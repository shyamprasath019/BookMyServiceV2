...
const ReviewForm = ({ order, onReviewSubmitted, existingReview = null }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Pass the new/updated review back to parent component
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <p className="mt-2 text-sm text-green-700">
              Thank you for sharing your feedback. Your review will help other users make informed decisions.
            </p>
          </div>
        </div>
      </div>
